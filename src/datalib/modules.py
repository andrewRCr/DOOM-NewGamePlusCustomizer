...
class ArgentCellUpgrades(InventoryModule):
    ...
    healthCapacity = ArgentPerk(
        'healthCapacity', '"perk/zion/player/sp/enviroment_suit/health_capacity"')
    armorCapacity = ArgentPerk(
        'armorCapacity', '"perk/zion/player/sp/enviroment_suit/armor_capacity"')
    ammoCapacity = ArgentPerk(
        'ammoCapacity', '"perk/zion/player/sp/enviroment_suit/ammo_capacity"')
